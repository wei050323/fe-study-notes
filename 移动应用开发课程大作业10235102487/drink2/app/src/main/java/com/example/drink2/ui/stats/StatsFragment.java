...
public class StatsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.activity_stats_overview, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        toggleGroup = view.findViewById(R.id.toggle_mode);
        monthContainer = view.findViewById(R.id.container_month);
        yearContainer = view.findViewById(R.id.container_year);

        textMonthTitle = view.findViewById(R.id.text_month_title);
        textMonthTotalCups = view.findViewById(R.id.text_month_total_cups);
        textMonthAvgInterval = view.findViewById(R.id.text_month_avg_interval);
        textMonthTotalPrice = view.findViewById(R.id.text_month_total_price);
        textMonthAvgDailyPrice = view.findViewById(R.id.text_month_avg_daily_price);
        textMonthCalorie = view.findViewById(R.id.text_month_calorie);
        textMonthSugar = view.findViewById(R.id.text_month_sugar);
        textMonthCaffeine = view.findViewById(R.id.text_month_caffeine);
        progressMonthCalorie = view.findViewById(R.id.progress_month_calorie);
        progressMonthSugar = view.findViewById(R.id.progress_month_sugar);
        progressMonthCaffeine = view.findViewById(R.id.progress_month_caffeine);
        layoutMonthBars = view.findViewById(R.id.layout_month_bars);
        MaterialButton buttonPrevMonth = view.findViewById(R.id.button_prev_month_overview);
        MaterialButton buttonNextMonth = view.findViewById(R.id.button_next_month_overview);

        textYearTitle = view.findViewById(R.id.text_year_title);
        textYearTotalCups = view.findViewById(R.id.text_year_total_cups);
        textYearAvgInterval = view.findViewById(R.id.text_year_avg_interval);
        textYearTotalPrice = view.findViewById(R.id.text_year_total_price);
        textYearAvgDailyPrice = view.findViewById(R.id.text_year_avg_daily_price);
        textYearCalorie = view.findViewById(R.id.text_year_calorie);
        textYearSugar = view.findViewById(R.id.text_year_sugar);
        textYearCaffeine = view.findViewById(R.id.text_year_caffeine);
        progressYearCalorie = view.findViewById(R.id.progress_year_calorie);
        progressYearSugar = view.findViewById(R.id.progress_year_sugar);
        progressYearCaffeine = view.findViewById(R.id.progress_year_caffeine);
        layoutYearBars = view.findViewById(R.id.layout_year_bars);
        MaterialButton buttonPrevYear = view.findViewById(R.id.button_prev_year);
        MaterialButton buttonNextYear = view.findViewById(R.id.button_next_year);
        ...
        buttonPrevYear.setOnClickListener(v -> {
            currentYear -= 1;
            updateYearUi();
        });

        buttonNextYear.setOnClickListener(v -> {
            currentYear += 1;
            updateYearUi();
        });
    ...
    private void updateMonthUi() {
        ...
        int dailyCalorieLimit = UserSettings.getStatsDailyCalorieLimit(requireContext());
        int dailySugarLimit = UserSettings.getStatsDailySugarLimit(requireContext());
        int dailyCaffeineLimit = UserSettings.getStatsDailyCaffeineLimit(requireContext());
        ...
        int bgColor = ContextCompat.getColor(requireContext(), R.color.divider_light);
        int okColor = ContextCompat.getColor(requireContext(), R.color.coffee_primary);
        int warnColor = ContextCompat.getColor(requireContext(), R.color.warning_red);
        ...
        int labelSpace = (int) getResources().getDimension(R.dimen.spacing_16);
